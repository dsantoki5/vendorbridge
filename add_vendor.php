...
if (isset($_POST['save'])) {
    ...
    mysqli_query(
        $conn,
        "INSERT INTO vendors
        (vendor_name, vendor_code, category, gst_number, contact_person, email, phone, address, status)
        VALUES
        ('$vendor_name','$vendor_code','$category','$gst','$contact_person','$email','$phone','$address','$status')"
    );
...
<head>
    ...
    <title>Add Vendor — VendorBridge ERP</title>
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            ...
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-sep">›</span>
                <span class="current">Add Vendor</span>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="form-header">
                    ...
                    <div>
                        ...
                        <p class="form-subtitle">Register a new vendor in the VendorBridge system</p>
                    </div>
                </div>
                ...
                <form method="POST">
                    <div class="form-body">
                        <div class="form-grid">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" name="vendor_name" placeholder="e.g. Tata Consultancy Services" required>
                            </div>

                            <!-- Vendor Code -->
                            <div class="form-row">
                                <label class="required">Vendor Code</label>
                                <input type="text" name="vendor_code" placeholder="e.g. VND-0042" required>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" name="gst" placeholder="e.g. 27AAPFU0939F1ZV">
                            </div>

                            <!-- Contact Person -->
                            <div class="form-row">
                                <label>Contact Person</label>
                                <input type="text" name="contact_person" placeholder="e.g. Rahul Sharma">
                            </div>

                            <!-- Email -->
                            <div class="form-row">
                                <label>Email</label>
                                <input type="email" name="email" placeholder="e.g. rahul@vendor.com">
                            </div>
                            ...
                            <div class="form-row full">
                                <label>Address</label>
                                <textarea name="address" placeholder="Street, City, State, PIN Code…"></textarea>
                            </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="vendor_list.php" class="btn-back">
