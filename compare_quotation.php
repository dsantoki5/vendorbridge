...
$result = mysqli_query(
    ...
    "SELECT
     ...
     ORDER BY quotations.price ASC"
);

$rowCount = mysqli_num_rows($result);

$check = mysqli_query($conn, "SELECT MIN(price) AS lowest FROM quotations");
...
<head>
    ...
    <title>Compare Quotations — VendorBridge ERP</title>
...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="compare_quotation.php" class="active">
                        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="main-content">
        ...
        <!-- TOPBAR -->
        <div class="topbar">
            <div class="topbar-title">Compare Quotations</div>
        ...
        <div class="page-body">
            ...
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-sep">›</span>
                <span class="current">Compare Quotations</span>
            </div>
            ...
            <div class="alert alert-info" style="margin-bottom:20px;">
                ...
                Quotations are sorted by price (lowest first). The best-value offer is highlighted in green.
            </div>
            ...
            <div class="section">
                ...
                <div class="table-header">
                    <div class="table-header-left">
                        <span class="section-title">All Quotations</span>
                        <span class="badge badge-info" style="margin-left:8px;">
                            <?php echo $rowCount; ?> total
                        </span>
                    </div>
                    <a href="quotation_list.php" class="btn-back" style="font-size:13px;">
                    ...
                    <table class="vendor-table">
                        ...
                        <?php if ($rowCount > 0):
                            ...
                            while ($row = mysqli_fetch_assoc($result)):
                                $isLowest = ($row['price'] == $lowest_price);
                        ?>
                            <tr style="<?php echo $isLowest ? 'background:var(--success-bg);' : ''; ?>">
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span style="color:var(--gray-700); font-weight:600; font-size:13.5px;">
                                            ₹ <?php echo number_format($row['price'], 2); ?>
                                        </span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <span style="
                                        ...
                                        font-size:13px;
                                    ">
                                        <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="color:var(--blue);">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                        <?php echo htmlspecialchars($row['delivery_days']); ?> days
                                    </span>
                                </td>
                ...
                <div style="padding:12px 22px; border-top:1px solid var(--gray-100); display:flex; align-items:center; justify-content:space-between; font-size:13px; color:var(--gray-500);">
                    <span>
                        ...
                        quotation<?php echo $rowCount !== 1 ? 's' : ''; ?>
                        &nbsp;·&nbsp;
                        Lowest price:
