...
$result = mysqli_query(
    $conn,
    "SELECT invoices.*, purchase_orders.po_number
     FROM invoices
...
<head>
    ...
    <title>Invoices — VendorBridge ERP</title>
        ...
        <div class="page-body">
            ...
            <div class="page-card">
                ...
                <div class="table-header">
                    <div class="table-header-left">
                        ...
                        <span class="badge badge-info" style="margin-left:8px;">
                            <?php echo mysqli_num_rows($result); ?> total
                        </span>
                    </div>
                    <div class="btn-group">
                        <a href="generate_invoice.php" class="btn-add">
                ...
                <div class="table-wrapper">
                    <table class="vendor-table" id="invoiceTable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Invoice No.</th>
                                        ...
                                        <svg viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2
                                                     0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0
                                                     00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2
                ...
                <div style="padding:12px 22px; border-top:1px solid var(--gray-100);
                    ...
                    <span>
                        ...
                        invoice<?php echo mysqli_num_rows($result) !== 1 ? 's' : ''; ?>
                    </span>
