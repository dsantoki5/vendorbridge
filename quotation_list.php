...
<head>
    ...
    <title>Quotation Management — VendorBridge</title>
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <!-- TOPBAR -->
        <div class="topbar">
            <div class="topbar-title">Quotation Management</div>
        ...
        <div class="page-body">
            ...
            <div class="section">
                ...
                <div class="table-header">
                    ...
                    <div class="btn-group">
                        <a href="compare_quotation.php" class="btn-outline btn-sm">
                            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                            </svg>
                            Compare
                        </a>
                        <a href="submit_quotation.php" class="btn-add">
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="empty-state">
                                        ...
                                        <p>Submit your first quotation to get started.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
