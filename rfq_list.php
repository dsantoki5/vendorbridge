...
$result = mysqli_query(
    $conn,
    "SELECT rfqs.*, vendors.vendor_name
     FROM rfqs
     LEFT JOIN vendors ON rfqs.vendor_id = vendors.id
     ORDER BY rfqs.id DESC"
);
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <!-- TOPBAR -->
        <div class="topbar">
            <div class="topbar-title">RFQ Management</div>
            ...
            <div class="section">
                ...
                <div class="table-header">
                    <div class="table-header-left">
                        <span class="section-title">All RFQs</span>
                        <span class="badge badge-info" style="margin-left:8px;">
                            <?php echo $rowCount; ?> total
                        </span>
                    </div>

                    <a href="create_rfq.php" class="btn-add">
                    ...
                    <table class="vendor-table">
                        ...
                        <?php if ($rowCount > 0): ?>
                            ...
                            <tr>
                                ...
                                <td style="color:var(--gray-700); font-weight:600;">
                                ...
                                <td>
                                    ...
                                    $today    = date('Y-m-d');
                                    $isUrgent = $deadline && $deadline <= date('Y-m-d', strtotime('+3 days'));
                                    $isPast   = $deadline && $deadline < $today;
                                    ?>
                                    <span style="
                                        color: <?php echo $isPast ? 'var(--danger)' : ($isUrgent ? 'var(--warning)' : 'var(--gray-600)'); ?>;
                                        font-weight: <?php echo ($isPast || $isUrgent) ? '600' : '400'; ?>;
                                        font-size: 13px;
                                    ">
                                        <?php echo $deadline ? date('d M Y', strtotime($deadline)) : '—'; ?>
                                        <?php if ($isPast): ?>
                                            <span class="badge badge-overdue" style="margin-left:4px; font-size:10px;">Overdue</span>
                                        <?php elseif ($isUrgent): ?>
                                            <span class="badge badge-pending" style="margin-left:4px; font-size:10px;">Urgent</span>
                                        <?php endif; ?>
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn-edit btn-sm"
                                           href="edit_rfq.php?id=<?php echo $row['id']; ?>">
                                        ...
                                        <a class="btn-delete btn-sm"
                                           href="delete_rfq.php?id=<?php echo $row['id']; ?>"
